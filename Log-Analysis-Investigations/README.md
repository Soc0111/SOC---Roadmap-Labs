...
16. **[Case 16: (Google)Network-traffic-analysis-in-Wireshark](./Log-Analysis-Investigations/(Google)Network-traffic-analysis-in-Wireshark/REAME.md)** - Traffic analysis lab in Wireshark (Screenshots included)
